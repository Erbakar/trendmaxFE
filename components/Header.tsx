            ...
            {NAVIGATION_MENU.map((menu) => (
              ...
              >
                {menu.items?.length ? (
                  ...
                  <Link
                    to={menu.path}
                    className="flex items-center text-sm font-semibold text-gray-700 hover:text-orange-600 transition-colors"
                  >
                    {menu.title}
                  </Link>
                )}
              ...
              <div key={menu.title} className="space-y-2">
                {menu.items?.length ? (
                  ...
                  <Link
                    ...
                    className="flex items-center p-4 rounded-xl hover:bg-orange-50 active:bg-orange-100 transition-colors"
                  >
                    <span className="text-sm font-bold text-gray-800">{menu.title}</span>
                  </Link>
                )}
              </div>
            ))}
